...
async def analyze_audio(
    ...
    try:
        ...
        audio_loading_ms = (t_load_end - t_load_start) * 1000

        # Stage 3-5: Noise Filtering, Resampling, Feature Extraction
        analysis_result, spectrogram_png, timings = process_audio_signal((y_norm, sr))
        ...
        print(f"  7. Response Generation:            {response_generation_ms:.2f} ms")
        print("-" * 75)
